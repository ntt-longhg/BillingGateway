package com.gateway.billing.modules.usagelog.service;
...
public class UsageLogService {
    ...
    private final com.gateway.billing.modules.servicecatalog.repository.ServiceRepository serviceRepository;
    private final WalletRepository walletRepository;
    private final MessageProducer messageProducer;

    public UsageLogService(UsageLogRepository usageLogRepository,
                           TenantRepository tenantRepository,
                           com.gateway.billing.modules.servicecatalog.repository.ServiceRepository serviceRepository,
    ...
    private UsageLogResponse toResponse(UsageLog ul) {
        return UsageLogResponse.builder()
                ...
                .serviceId(ul.getService().getId())
                .serviceCode(ul.getService().getCode())
