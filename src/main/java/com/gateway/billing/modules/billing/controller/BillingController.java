package com.gateway.billing.modules.billing.controller;
...
import com.gateway.billing.modules.billing.service.BillingService;
    ...
    private Tenant extractTenantFromApiKey(String apiKey) {
        ...
        return tenantRepository.findByClientId(clientId)
                .orElseThrow(() -> {
                    ...
                    return new com.gateway.billing.core.exception.ResourceNotFoundException("Tenant", "clientId", clientId);
                });
    }
}
